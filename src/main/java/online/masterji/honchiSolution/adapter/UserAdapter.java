...
import online.masterji.honchiSolution.activity.ChatActivityMainChat;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public UserAdapter(Context context, List<MessageList> arrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext, ChatActivityMainChat.class);
                //  intent.putExtra("list", list.get(position));

                intent.putExtra("id", arrayList1.get(position).getId());
                intent.putExtra("list", arrayList1.get(position).getFullname());
