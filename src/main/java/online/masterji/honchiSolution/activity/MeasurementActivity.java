...
public class MeasurementActivity extends AppCompatActivity {
    ...
    String city;
    LinearLayout linearGender, parentLayoutt;
    ...
    String Name;
    RadioButton rbMaleee, rbFemaleee;
    RadioGroup rgGender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearGender = findViewById(R.id.linearGender);
        rgGender = (RadioGroup) findViewById(R.id.rgGender);

        rbMaleee = findViewById(R.id.rbMaleee);
        rbFemaleee = findViewById(R.id.rbFemaleee);
    ...
    String WaistTop, name, addFamily, Gender, strings, Wrist, Title1, Thigh,Title, Chest, Biceps, ArmLength, Extra, Hips, Id, Inseam, Knee, LengthBottom, LengthTop, Mohri, Neck, Round, Shoulder, SleeveLngth, WaistBottom;

    private void getMeasurement() {
        Intent intent = getIntent();
        addFamily = intent.getStringExtra("addFamily");

        try {
            if (addFamily.equals("addFamily")) {
        ...
        Thigh = intent.getStringExtra("Thigh");
        ...
        try {
            if (Gender.equals("Male")) {
                rbMaleee.setChecked(true);

            } else {
                rbFemaleee.setChecked(true);
    ...
    public void MeasurmentPlus(View view) {
        ...
        String gender = rbMaleee.isChecked() ? "Male" : "Female";
        ...
        String Thigh = etThigh.getText().toString().trim();
        ...
        try {
            if (addFamily.equals("addFamily")) {
                if (!rbMaleee.isChecked() && !rbFemaleee.isChecked()) {
        ...
        if (Thigh.isEmpty()) {
            SnackBarUtil.showWarning(this, parentLayoutt, "Enter Thigh");
            return;
        }if (Name.isEmpty()) {
            ...
            measurment.setThigh(etThigh.getText().toString().trim());
            ...
            measurment.setGender(rbMaleee.isChecked() ? "Male" : "Female");
            ...
            db.collection("Measurment").document(Name)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            waitDialog.dismiss();
                            SnackBarUtil.showSuccess(MeasurementActivity.this, parentLayoutt, "Measurment Successfully ");
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            waitDialog.dismiss();
                            SnackBarUtil.showError(MeasurementActivity.this, parentLayoutt, "Measurment Failed,Please Try Again!");
                        }
                    });
        }
    }
