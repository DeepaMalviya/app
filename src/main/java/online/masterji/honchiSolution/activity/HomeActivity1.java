    ...
    private void startTimer() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (EasyPermissions.hasPermissions(HomeActivity1.this, Constants.permissions)) {
                    //Toast.makeText(this, "Opening camera", Toast.LENGTH_SHORT).show();


                } else {

                    showPermissionDialog(HomeActivity1.this);
...
/*EasyPermissions.requestPermissions(HomeActivity.this, "We need permissions",
    ...
    private void showPermissionDialog(HomeActivity1 homeActivity) {
        ...
        tvGive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (EasyPermissions.hasPermissions(HomeActivity1.this, Constants.permissions)) {
                    ...
                    EasyPermissions.requestPermissions(HomeActivity1.this, "We need permissions",
                            123, Constants.permissions);
                }
    ...
    private void initView() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HomeActivity1.this, NavActivity.class);
...
/*   Log.e(TAG, "onSuccess:getUid " + user.getUid());
    ...
    private void setDatabaseSlider(List<Slider> sliders) {
...
*//*
    ...
    private void setSliders(Slider slider) {
        ...
        // requestOptions.placeholder(R.drawable.top_slide_1);
        // requestOptions.error(R.drawable.top_slide_1);
