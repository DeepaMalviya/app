      ...
      /*  gridview.setAdapter(new Category1Adapter(this, this.dataList));
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent,
                ...
                Log.e(TAG, "onItemClick:getProductid==== " + ProductListActivity1.this.dataList.get(position).getId());
                Log.e(TAG, "onItemClick:getProductid==== " + ProductListActivity1.this.dataList.get(position).getProductId());
                Log.e(TAG, "===========:getTitle==== " + ProductListActivity1.this.dataList.get(position).getTitle());
                Intent intent = new Intent(ProductListActivity1.this, ProductActivity.class);
                intent.putExtra("product", ProductListActivity1.this.dataList.get(position));
